...
L1688={'size_x' : 9, 'size_y' : 7, 
    ...
    'cumulative_bins':20,
    'nh3_temp_lim':np.array([6.,35.]),
    'her_temp_lim':np.array([13.,40]),
...
B18={'size_x' : 19, 'size_y' : 7, 
    ...
    'cumulative_bins':20,
    'nh3_temp_lim':np.array([7.,18.]),
    'her_temp_lim':np.array([10.,18]),
    'xnh3_lim':np.array([-9,-7])}
...
NGC1333={'size_x' : 8, 'size_y' : 13.3, 
    ...
    'cumulative_bins':20,
    'nh3_temp_lim':np.array([6.,25.]),
    'her_temp_lim':np.array([10.,28]),
    'xnh3_lim':np.array([-8.7,-7])}
...
OrionA={'size_x' : 4.5, 'size_y' : 11.25, 
    ...
    'h2_col_lim':np.array([21.2,23.2]),
    'cumulative_bins':20,
    'nh3_temp_lim':np.array([5.,60.]),
    'her_temp_lim':np.array([5.,80]),
